        ...
        <div className="bg-white rounded-b-xl shadow-2xl p-8 border-4 border-black border-t-0">
          {loading ? (
            ...
            <div className="text-center">
              ...
              <div className="flex gap-2 justify-center mt-4">
                {pokemon.types.map((t) => (
                  <span key={t.type.name} className="px-4 py-2 bg-blue-500 text-white rounded-full font-semibold">
                    {t.type.name}
                  </span>
                ))}
              </div>
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg border-2 border-blue-200">
            <p className="text-sm text-blue-800">
              💡 <strong>CSR:</strong> los datos se cargan en el navegador después del render. Revisa la pestaña
              <em> Network</em>.
            </p>
          </div>
        </div>
